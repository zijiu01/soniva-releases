...
| 页面数据 | `public/releases/0.1.2.md`（channel: released，首发即 0.1.2——0.1.0/0.1.1 从未公开发布，条目已删）+ `public/devlog/*.md` **真实开发日志 31 篇**：总览《从 0 到 v0.1.2》1 篇 + 按天日志 27 篇（2026-08-24→09-20，desktop git log 按作者日逐日落档，1150 提交，随上游更新增量重生成）+ 桌面端原文档 3 份；`mock-entries.ts` 已删除，timeline.ts 已摘除调用 |
